...
class Follower:
	...
	def positionUpdateCallback(self, position):
		...
		# rospy.loginfo("distance = {}, angle= {}".format(distance, angleX))
		
		if(angleX>3.1415):
			angleX=angleX-6.2830
		...
		# rospy.loginfo("distance = {}, angle= {}".format(distance, angleX))
		# rospy.loginfo("uncliped_lin_speed: {}, uncliped_ang_speed: {}".format(uncliped_lin_speed, uncliped_ang_speed))
